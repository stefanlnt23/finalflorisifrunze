        ...
        <div className="py-16 bg-red-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-3xl font-bold text-red-700 mb-4">
              ID-ul articolului de blog este invalid
            </h1>
            <p className="text-lg text-red-600 mb-6">
              ID-ul articolului de blog furnizat nu este valid.
            </p>
    ...
    return (
      <MainLayout>
        <div className="py-16 bg-red-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-3xl font-bold text-red-700 mb-4">
              Articolul de blog nu a fost găsit
            </h1>
            <p className="text-lg text-red-600 mb-6">
              Articolul de blog pe care îl căutați nu a putut fi găsit sau a
              fost eliminat.
            </p>
            <Link href="/blog" state={{ from: "blogDetail" }}>
              <Button className="bg-green-600 hover:bg-green-700">
            ...
            switch (section.type) {
              ...
              case "quote":
                return (
                  <blockquote
                    key={index}
                    className="border-l-4 border-green-600 pl-4 py-2 italic my-8 text-gray-700"
                  >
                    <p>{section.content}</p>
                    {section.caption && (
              ...
              case "heading":
                const HeadingTag =
                  `h${section.level || 2}` as keyof JSX.IntrinsicElements;
                return (
                  <HeadingTag
                    key={index}
      ...
      <article className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Blog Content */}
            <div className="mb-12">{renderBlogContent()}</div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-900">
                    Echipa Flori si Frunze
                  </h3>
                  <p className="text-gray-600">
                    Experți în grădinărit și amenajare peisagistică cu ani de
                    experiență în crearea de spații exterioare frumoase.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 p-8 rounded-lg border border-green-100 mb-8">
              <h3 className="text-xl font-bold text-gray-900 mb-3">
                Aveți nevoie de ajutor cu grădina dvs.?
              </h3>
              <p className="text-gray-600 mb-4">
                Echipa noastră de experți este gata să vă ajute cu toate nevoile
                dvs. de grădinărit. Contactați-ne astăzi pentru a programa o
                consultație.
              </p>
